...
public class MySQLTokenizerConfigurator implements TokenizerConfigurator {
    ...
    public void configure(Tokenizer tokenizer) {
        ...
        tokenizer.addTokenPattern(TokenType.LITERAL, "\\d+", "");
        tokenizer.addTokenPattern(TokenType.LITERAL, "'[^']*'", "");
    }
}
